...
def test_json2cleandf():
    clean_df, objectIds_withoutAlert_col = json2cleandf(test_json_path)
    ...
    assert clean_df.shape[0] == 43, "The clean data frame should have 44 rows. WARNING: TEST FILE SPECIFIC"
